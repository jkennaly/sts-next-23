...
function Use (id, opts = {}) {
	...
	this.action = ActionClass.prototype.actionFactory.call(this, {
		...
		sourceConnectionName: 'user',
		targetConnectionName: 'used'
		/*
		targetValue: {
...
Use.prototype = Object.create(ActionClass.prototype)


Use.prototype.effectInterlock = function(effects) {
	return false
}

/*

Use.prototype.action = function (engine) { return targetId => {
	this.effects = {
